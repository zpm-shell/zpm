...
function removeFilePathFlag(args) {
    for (let index = 0; index < args.length; index++) {
        const arg = args[index];
...
function removeOutputFlag(args) {
    for (let index = 0; index < args.length; index++) {
        const arg = args[index];
...
function replaceVariable(filePath, nameMapVal) {
...
function checkHasPrintDocFlag(args) {
    for (let index = 0; index < args.length; index++) {
...
//# sourceMappingURL=replace-variable.js.map