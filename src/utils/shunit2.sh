...
# Return if shunit2.sh already loaded.
...
#
# If this function exists, it will be called when shunit2.sh is sourced. If it
# does not exist, shunit2.sh will search the parent script for all functions
